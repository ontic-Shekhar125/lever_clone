...
class Formele extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this.innerHTML=`
            ...
            <label class="flex  items-center mb-2 text-gray-600 text-sm font-medium">${label || val} <svg width="7" height="7" class="ml-1" viewBox="0 0 7 7" fill="none" xmlns="http://www.w3.org/2000/svg">
